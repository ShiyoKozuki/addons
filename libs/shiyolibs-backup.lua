...
ashita.events.register('packet_in', 'mob_extdata_packet_cb', function (e)
    if (e.id == 0x00A) then
        thTable = {}
        buffTable = {}  -- Reset the buff table too when a new zone/mob data is loaded
    end
    if (e.id == 0xFF) then
        ...
        buffTable[mobIndex] = buffs;  -- Store the buffs for the mob
...
-- {
--     [1] = { Gorget = 'Soil Gorget', Weaponskills = T{ 'Aeolian Edge', 'Asuran Fists', 'Avalanche Axe', 'Blade: Ku', 'Blade: Retsu', 'Blade: Ten', 'Calamity', 'Catastrophe', 'Crescent Moon', 'Dancing Edge', 'Entropy', 
--         'Evisceration', 'Exenterator', 'Expiacion', 'Fast Blade', 'Hard Slash', 'Impulse Drive', 'Iron Tempest', 'King\'s Justice', 'Leaden Salute', 'Mercy Stroke', 'Nightmare Scythe', 
--         'Omniscience', 'Primal Rend', 'Pyrrhic Kleos', 'Rampage', 'Requiescat', 'Resolution', 'Retribution', 'Savage Blade', 'Seraph Blade', 'Shattersoul', 'Shining Blade', 'Sickle Moon', 
--         'Slice', 'Spinning Axe', 'Spinning Scythe', 'Spiral Hell', 'Stardiver', 'Stringing Pummel', 'Sturmwind', 'Swift Blade', 'Tachi: Enpi', 'Tachi: Jinpu', 'Tachi: Rana', 'Trueflight', 
--         'Viper Bite', 'Vorpal Blade', 'Vorpal Scythe', 'Wasp Sting' }
--     },
-- }
...
local isZoning = (AshitaCore:GetMemoryManager():GetParty():GetMemberTargetIndex(0) == 0);
